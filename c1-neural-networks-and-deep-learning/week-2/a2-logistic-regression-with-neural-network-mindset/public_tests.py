...
def dataset_test(m_train, m_test, num_px):
    assert m_train == 209, "Wrong m_train"
    assert m_test == 50, "Wrong m_test"
    assert num_px == 64, "Wrong num_px"
    print('\033[92mAll tests passed!')

def reshape_test(train_set_x_flatten, test_set_x_flatten):
