...
def generate_music(inference_model, indices_tones, chords, diversity = 0.5):
    ...
    mf.open("outputs/my_music.midi", 'wb')
    mf.write()
    print("Your generated music is saved in outputs/my_music.midi")
    mf.close()
...
def predict_and_sample(inference_model, x_initializer = x_initializer, a_initializer = a_initializer, 
    ...
    results = tf.keras.utils.to_categorical(indices, num_classes=90)
    ### END CODE HERE ###
...
def mid2wav(file):
    ...
    output.export("./outputs/rendered.wav", format="wav")
